...
description: "Meet Stradocs, an open-source Astro theme designed for building modern documentation sites and blogs."
pubDate: 2026-08-16
...
**Stradocs** is an open-source Astro theme designed to give developers a solid foundation for building documentation sites, blogs, and content-focused websites.
...
Stradocs brings these pieces together in a single Astro project.

The goal is not to provide every possible feature. Instead, Stradocs focuses on providing the essential foundations while leaving enough room for you to shape the site around your own project.

## Built with Astro

Astro is at the core of Stradocs.
...
This allows Stradocs to remain lightweight without sacrificing the flexibility needed for modern websites.

Stradocs also uses Astro Content Collections to organize and validate documentation, blog posts, and other content.

## Documentation First

Documentation is one of the main reasons Stradocs exists.
...
Stradocs extends the content experience with custom directives such as:
...
Stradocs includes a built-in blog system for announcements, development updates, tutorials, and project-related articles.
...
Stradocs also includes the foundations needed for a production-ready content site.
...
Stradocs is designed to be customized rather than treated as a black box.
...
Stradocs is being developed as a foundation for developers who want a modern content site without having to build the entire system themselves.
...
You can also explore the [Project Structure](/docs/project-structure/) and [Configuration](/docs/configuration/) guides to learn how Stradocs is organized and customized.

Stradocs is open source, and feedback, ideas, and contributions are always welcome.
