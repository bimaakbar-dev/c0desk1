...
slug: 'tech-stack'
title: "Tech Stack"
description: "Technologies powering the Unloyd template."
...
Unloyd is built with a modern, production-ready stack.
...
Astro 7 ships with [Sätteri](https://satteri.bruits.org) as the default Markdown parser, enabling custom directives like callout, steps, tabs, and filetree out of the box.
